    (function ($) {
        ...
        $.fn.profileAjax = function () {
            var link = $(this);
            console.log(this);
//            this.filter("a").each(function () {
            var username = link.attr('data-username');
            var url = link.attr('data-url') + username;
...
//
        ...
        $.fn.showLinkLocation = function () {
            ...
            this.filter("a").each(function () {
                var link = $(this);
                $('#testerr').append(link.attr("data-username"));
            });
    ...
    $.fn.myPlugin = function(method, options) {
        ...
        var settings,
            ...
            methods = {
                giveBorder: function() {$(this).css({border: '2px solid black'});}
                /* all your named methods here, you can use values from settings inside*/
            }
        settings = $.extend({}, defaults, options); // merge defaults and options together
...
var newli = $('<li>Dynamic</li>').myPlugin();

$('ul').append(newli);

newli.myPlugin('giveBorder');
